...
public class Grade extends Workers implements Serializable{
	...
	public Grade(int code, String name, String surname, String gender, int grade, Specialty specialty, Date workingYears,
			int assessment) {
